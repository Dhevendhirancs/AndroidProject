...
public class Camera2VideoFragment extends Fragment
    ...
    public void switchCamera() {
        if (cameraId.equals(CAMERA_FRONT)) {
            ...
            closeCamera();
            reopenCamera();
            mInfo.setImageResource(R.drawable.ic_action_info);

        } else if (cameraId.equals(CAMERA_BACK)) {
            cameraId = CAMERA_FRONT;
            closeCamera();
            reopenCamera();
            mInfo.setImageResource(R.drawable.ic_menu_send);
        }
    }
    ...
    private void stopRecordingVideo() {
        ...
        if (null != activity) {
            ...
            uploadImage(mNextVideoAbsolutePath);
        }
    ...
    public static void uploadImage(String sourceImageFile) {
            ...
            RequestBody requestBody = new MultipartBody.Builder()
                    ...
                    .addFormDataPart("video", sourceImageFile, RequestBody.create(MEDIA_TYPE, sourceFile))
                    .addFormDataPart("result", "my_image")
                    .build();

            Request request = new Request.Builder()
                    .url("http://vaquacrm.in/videos/upload.php")
                    .post(requestBody)
                    .build();
